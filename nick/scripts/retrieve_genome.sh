...
gunzip -c $OUTGCF_000001635.27_GRCm39/GCF_000001635.27_GRCm39_genomic.fna.gz > $OUT/genome.fa
gunzip -c $OUTGCF_000001635.27_GRCm39/GCF_000001635.27_GRCm39_genomic.gtf.gz > $OUT/genome.gtf